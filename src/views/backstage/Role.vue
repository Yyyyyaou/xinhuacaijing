  ...
  <div class="user" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading">
    ...
    <div class="userList">
      ...
      >
        ...
        <el-table-column label="角色" align="center"  prop="role" width="300"></el-table-column>
        <el-table-column label="描述" align="center"  prop="describe" width="300"></el-table-column>
        <el-table-column label="创建时间" align="center"  prop="data" width="300"></el-table-column>
        <el-table-column label="状态" align="center" width="235">
...
export default {
  ...
  methods: {
    ...
    confirmEdit() {
      ...
      this.users[editdata].role = this.Form.role;
      this.users[editdata].describe = this.Form.describe;
