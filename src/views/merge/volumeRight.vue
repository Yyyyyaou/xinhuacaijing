  ...
  <div>
        ...
        >
          ...
          <div style="text-align: right; margin-top: 40px">
            <el-button
              ...
              type="info"
              icon="el-icon-close"
              @click="visiblepopoverRight = false"
            ></el-button>
            <el-button
              type="primary"
              icon="el-icon-check"
    ...
    <div class="targetaTable">
      ...
      >
        ...
        <el-table-column prop="name" label="Industry" align="center">
        </el-table-column>
        <el-table-column
          prop="heatvalue"
          label="Heat value"
...
export default {
  data() {
    return {
      ...
      visiblepopoverRight: false,
      tableData: [
        {
          enterprisename: "Jingdong Technology Co., LTD",
          name: "The electronic commerce",
          heatvalue: "45346",
        },
        {
          enterprisename: "Bjink bancorp",
          name: "Bnnner bancorp",
          heatvalue: "226",
        },
        {
  ...
  methods: {
    addDataRight() {
      this.visiblepopoverRight = false;
    },
    // 表格的样式
    cellStyle(data) {
      if (
        ...
        if (
          (data.columnIndex === 1 && data.rowIndex === 0) ||
          (data.columnIndex === 2 && data.rowIndex === 0)
        ) {
